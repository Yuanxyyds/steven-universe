...
echo "Building vllm-worker Docker image..."
...
echo "✓ vllm-worker:latest built successfully"
echo ""
echo "Test the worker:"
echo "  docker run --gpus all -p 8000:8000 -p 8001:8001 vllm-worker:latest"
echo ""
echo "Test health:"
echo "  curl http://localhost:8000/health"
echo ""
echo "Note: Model loading takes 30-120s depending on model size and GPU"
