"""
Download Pipeline Test Worker Client - HTTP client for download-pipeline test worker.

Implements GPUWorkerProtocol for download pipeline worker communication.
"""
...
from shared_schemas.worker.test.download_pipeline.schemas import DownloadPipelineTaskRequest

logger = logging.getLogger(__name__)


class DownloadPipelineClient(GPUWorkerProtocol):
    """
    Client for communicating with download-pipeline test worker containers.
